...
<div id="nav">
	...
	<ul class="nav nav-tabs" role="navigation">
		...
		<li role="presentation" id="nav3"><a href="<c:url value="/scrollList"/>" title="로그인 후 이용 가능합니다">GUEST BOARD</a></li>
		<li role="presentation" id="nav3"><a href="<c:url value="/youTube"/>">SEARCH VOIDEO</a></li>
