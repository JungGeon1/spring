	...
	<script>
		$(document).ready(function() {
			...
			$('#form').submit(function() {
				...
				$.ajax({
					url : 'http://ec2-54-180-95-162.ap-northeast-2.compute.amazonaws.com:8080/ps/members/reg',
					type : 'POST',
					data : formData,
		...
		// 중복 아이디 체크
		function checkId() {
//http://ec2-54-180-95-162.ap-northeast-2.compute.amazonaws.com:8080/adoptDog/rest
			var id = $('#id').val();
			if (id.length < 1) {
				alert('아이디를 입력해주세요!');
			} else {
