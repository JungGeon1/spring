    ...
    Kakao.init('83c20064cc01d434b441d9ae9303903d');
     ...
     // 로그아웃
        ...
        function myInfo() {
            ...
            $.ajax({
                url: 'http://ec2-54-180-95-162.ap-northeast-2.compute.amazonaws.com:8080/ps/members/mypage',
                type: 'GET',
                data: {id: id},
                success: function(data) {
        ...
        function edit(id) {
            ...
            $.ajax({
                url: 'http://ec2-54-180-95-162.ap-northeast-2.compute.amazonaws.com:8080/ps/members/mypage/id',
                type: 'GET',
                data: {
                    id: id
                },
