    ...
    Kakao.init('582e4d9c58d4a5fb561e39ea1d4f40b9');
        ...
        $(document).ready(function() {
            $('#form').submit(function() {
                ...
                $.ajax({
                    url: 'http://ec2-54-180-95-162.ap-northeast-2.compute.amazonaws.com:8080/ps/members/login',
                    type: 'POST',
                    data: $('#form').serialize(),
                    success: function(data) {
                        ...
                        if (data.view == 'success') {
                            ...
                            /* Swal.fire('인증되었습니다!')*/
                            /* location.href = "http://ec2-54-180-95-162.ap-northeast-2.compute.amazonaws.com:8080/psClient/index.jsp"; */
                        ...
                        if (data.view == 'undefined') {
                            ...
                            if (chk) {
                                $.ajax({
                                    url: 'http://ec2-54-180-95-162.ap-northeast-2.compute.amazonaws.com:8080/ps/members/verify/resend',
                                    data: {
                                        id: id
                                    },
                                    type: 'GET',
